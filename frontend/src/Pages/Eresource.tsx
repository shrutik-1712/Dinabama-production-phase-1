  ...
  return (
    <Card className="flex flex-col h-full">
      ...
      <CardFooter className="flex-none pt-4">
        <Button asChild className="w-full bg-[#1B1464]">
          <a 
            href={resource.link} 
            target="_blank" 
...
const resources: Resource[] = [
  ...
  },
  {
    ...
    description: "NCERT (National Council of Educational Research and Training) e-books are digital versions of textbooks used in Indian schools, primarily from classes 1 to 12. These books are authored by NCERT, covering subjects like Mathematics, Science, Social Science, and languages. They are designed to provide a standardized and well-researched curriculum, easily accessible for students, teachers, and parents through the NCERT website and mobile apps like ePathshala. These e-books are free to download, making quality education materials widely accessible across India.",
    imageUrl: picture6,
